...
class PoHeader extends Model
{
    ...
    "driver_name", "status", "create_by", "dest_name", "dest_address1", "dest_address2", "dest_province", "dest_city", "dest_area", 
    "dest_sub_area", "dest_postal_code", "dest_village", "dest_remarks", "ori_name", "ori_address1", "ori_address2", "ori_province", 
    "ori_city", "ori_area", "ori_sub_area", "ori_postal_code", "ori_village", "ori_remarks", "fulfillment_center_id", 
    "interface_job_id", "inteface_time", "dest_country", "ori_country");
